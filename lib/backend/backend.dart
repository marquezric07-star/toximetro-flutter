...
import 'schema/simulations_record.dart';
...
export 'schema/simulations_record.dart';
...
/// Functions to query SimulationsRecords (as a Stream and as a Future).
Future<int> querySimulationsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SimulationsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SimulationsRecord>> querySimulationsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SimulationsRecord.collection,
      SimulationsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SimulationsRecord>> querySimulationsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
